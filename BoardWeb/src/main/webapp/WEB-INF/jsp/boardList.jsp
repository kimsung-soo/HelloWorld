...
<form action="boardList.do">
  <div class="row">
    ...
    <div class="col-sm-6">
      <input type="text" name="keyword" class="form-control" value="${empty search.keyword ? '0' : search.keyword}">
    </div>
    <div class="col-sm-2">
...
<ul class="pagination justify-content-center">
 ...
 <c:choose>
  ...
  <c:otherwise>
    <li class="page-item">
      <a class="page-link" href="boardList.do?page=${paging.start - 1}">Previous</a>
    </li>
  </c:otherwise>
</c:choose>
...
<c:forEach var="p" begin="${pageInfo.start }" end="${pageInfo.end }">
  <c:choose>
    <c:when test="${p ne pageInfo.currentPage }">
      <li class="page-item">
        <a class="page-link" 
           href="boardList.do?searchCondition=${search.searchCondition}&keyword=${search.keyword}&page=${p}">${p} </a>         
      </li>
    </c:when>
    <c:otherwise>
  ...
  <c:otherwise>
    <li class="page-item">
      <a class="page-link" href="boardList.do?page=${paging.start + 1}">Next</a>
    </li>
  </c:otherwise>
</c:choose>
